...
description: From first issue to merged pull request.
order: 1
---
...
Browse the [issue tracker](https://github.com/onemnemo/mnemo/issues). Good first contributions are usually small and self-contained: a reproducible bug, a rough edge in the UI, a missing piece of documentation. Comment on the issue before starting so nobody duplicates the work.
